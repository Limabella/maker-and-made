...
* **Automated Video Testing:** Project-local TRN-N tooling supports file-based testing with fixtures from `src/projects/oniontest/teams/health-team/trn-n/fixtures/`.
