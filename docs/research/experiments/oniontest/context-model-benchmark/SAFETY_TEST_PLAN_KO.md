...
python .\docs\research\experiments\oniontest\context-model-benchmark\benchmark.py `
  ...
  --repetitions 3 `
  --output .\docs\research\experiments\oniontest\context-model-benchmark\results\raw\safety-model-abc.json
```

Git Bash에서는 한 줄로 실행한다.

```bash
python ./docs/research/experiments/oniontest/context-model-benchmark/benchmark.py --cases ./docs/research/experiments/oniontest/context-model-benchmark/safety_cases.jsonl --prompt ./docs/research/experiments/oniontest/context-model-benchmark/prompts/mnd_n_signal_safety_v1.txt --repetitions 3 --output ./docs/research/experiments/oniontest/context-model-benchmark/results/raw/safety-model-abc.json
```
