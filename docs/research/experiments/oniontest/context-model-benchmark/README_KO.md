...
```text
docs/research/experiments/oniontest/context-model-benchmark/
|-- README_KO.md
|-- cases.jsonl
...
ollama create onion-model-a `
  -f .\docs\research\experiments\oniontest\context-model-benchmark\models\model-a.Modelfile
```

저장소 루트에서 다음 명령으로 한 문장씩 시험한다.

```powershell
.\docs\research\experiments\oniontest\context-model-benchmark\manual_test.ps1 `
...
```powershell
.\docs\research\experiments\oniontest\context-model-benchmark\run_cases.ps1 `
  -Model "onion-model-a"
```
...
```powershell
python .\docs\research\experiments\oniontest\context-model-benchmark\benchmark.py `
  --repetitions 1 `
  --output .\docs\research\experiments\oniontest\context-model-benchmark\results\raw\model-abc.json
```
...
```powershell
python .\docs\research\experiments\oniontest\context-model-benchmark\benchmark.py `
  --cases .\docs\research\experiments\oniontest\context-model-benchmark\safety_cases.jsonl `
  --prompt .\docs\research\experiments\oniontest\context-model-benchmark\prompts\mnd_n_signal_safety_v1.txt `
  --repetitions 1 `
  --output .\docs\research\experiments\oniontest\context-model-benchmark\results\raw\safety-model-abc-smoke.json
```
